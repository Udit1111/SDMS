...
<body>
    ...
    <div id = "block">
        ...
        <asp:TextBox ID="Usernmtxtbx" runat="server" placeholder="Username" ToolTip="Enter Username"></asp:TextBox>
        
        <label id="pass" for="password">k</label>
        <!--<asp:Label ID="passwdlbl" runat="server" CssClass="lbl">k</asp:Label>-->
        
        <asp:TextBox ID="Passtxtbx" runat="server" TextMode="Password" placeholder="Password" ToolTip="Enter Password"></asp:TextBox>
        
        <asp:Button ID="loginbtn" runat="server" onclick="loginbtn_Click" Text="a" Font-Names="Wingdings 3" />
    </div>
    <div id="option">   
        <p>LOGIN</p>
        <!--<a href="XX">forgot?</a> -->
