<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PHView.aspx.cs" Inherits="MyWebApp.WebPages.PHView" MasterPageFile="~/WebPages/PHMaster.Master" %>
...
<asp:Content ContentPlaceHolderID="CPH1" runat="server">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="viewnoticedatasource" runat="server" 
            ...
            SelectCommand="SELECT [Subject], [Type], [Notice], [Comment], [dateofpost] FROM [PriHodPost] ORDER BY [dateofpost] DESC">
        </asp:SqlDataSource>
