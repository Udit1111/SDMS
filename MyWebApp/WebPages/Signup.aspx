...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="usernametxtbox" runat="server" AutoPostBack="true" OnTextChanged="usernametxtbox_TextChanged1"></asp:TextBox>
        <div id="checkuser1" visible="false" runat="server" style="right: auto">
        <asp:Label ID="lbluserstatus" runat="server"></asp:Label>
        </div>
        </contenttemplate>
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="usernametxtbox" EventName="TextChanged" />
            </Triggers>
        </asp:UpdatePanel>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="fenrolnotxtbox" runat="server"></asp:TextBox>
                <br />
                <br />
                <asp:Label ID="DeptLbl0" runat="server" Text="Department:"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:DropDownList ID="deptdropdwnlist0" runat="server">
        ...
        <Triggers>
         <asp:AsyncPostBackTrigger ControlID="Usertyperblist" EventName="SelectedIndexChanged" />
        </Triggers>
        </asp:UpdatePanel>
